...
<Link href="/messages">
        <DropdownMenuItem
          ...
          >
            ...
            <span className="text-sm font-medium">{t("header.messages")}</span>
          <span className='text-sm text-center rounded-full w-5 h-5 text-white bg-primary'>{totalUnreadMessages}</span>

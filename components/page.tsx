  ...
  return (
    <section className="h-full pb-36 bg-hero-pattern bg-cover  w-full">
      <div className="container relative mx-auto h-full flex flex-col gap-44">
        ...
        <div className="flex relative flex-col pt-40 pl-18 gap-3 ">
          <h1 className="text-7xl font-semibold text-secondary">
            All Properties <br />
            on one lace
          </h1>
        ...
        <div className="relative w-[1450] ml-14  h-36 bg-[#F5F5F5] bg-opacity-80 flex  items-center px-8 rounded-md justify-center ">
          {/* top search */}
          <div className="absolute -top-7 left-[500] bg-secondary text-white flex justify-between items-center w-1/3 h-[60] px-6 py-6 rounded-sm">

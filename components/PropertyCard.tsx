...
function PropertyCard() {
  return (
    <div className="relative  max-w-md mx-auto bg-white rounded-[10px] shadow-md overflow-hidden md:max-w-[350px]">
<div className="absolute text-white bg-primary text-sm px-6 py-1 top-3">For Rent</div>
<div className="absolute text-white bg-secondary text-sm px-6 py-1 top-12">Apartment</div>
    ...
    <div className="p-3 flex flex-col gap-2">
      ...
      <div className="flex gap-3 justify-center">
        <div className="flex items-center gap-1">
          <LiaBedSolid  className="text-primary text-2xl" /> <span>5 rooms</span>
        </div>

        <div className="flex items-center gap-1">
          <PiBathtubLight className="text-primary text-2xl" /> <span>5 bath</span>
        </div>
        <div className="flex items-center gap-1">

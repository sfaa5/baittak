...
function ShowCards({ data }) {
  ...
  const initialProperties = Array.isArray(data?.properties) ? data.properties : [];
...
<Fllter   originalProperties={initialProperties} setFilteredProperties={setFilteredProperties}/>
...
properties.map((post,key:number)=>{
  ...
  return(
  <PropertiesCard  key={key} post={combinedProps} />
